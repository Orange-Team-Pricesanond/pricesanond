            ...
            {{ csrf_field() }}
                ...
                <div class="row form-group">
                    <div class="col-lg-2">
                        ...
                        <select id="yf_currency" name="yf_currency" class="form-control" data-live-search="true" title="Please select">
                            <option value="USD" {{ ( $_getID->yf_currency == "USD" ? "selected" : "") }} >USD</option>
                            <option value="THB" {{ ( $_getID->yf_currency == "THB" ? "selected" : "") }} >THB</option>
                        </select>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <select id="yf_currencyter" name="yf_currencyter" class="form-control" data-live-search="true" title="Please select">
                            <option value="USD" {{ ( $_getID->yf_currencyter == "USD" ? "selected" : "") }} >USD</option>
                            <option value="THB" {{ ( $_getID->yf_currencyter == "THB" ? "selected" : "") }} >THB</option>
                        </select>
                    </div>
                    <div class="col-lg-2">
                        <label>Fix Fee</label>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-2">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="yf_rates_b" name="yf_rates_b"  value="{{ $_getID->yf_rates_a }}">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="input-group mb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control" id="yf_taxnumber" name="yf_taxnumber" value="{{ $_getID->yf_taxnumber }}">
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="row form-group">
                    <div class="col-lg-4">
                        <label>Country</label>
                        <input type="text" class="form-control" id="yf_country" name="yf_country" value="{{ $_getID->yf_country }}">
                    </div>
                    <div class="col-lg-4">
                        <label>Province</label>
                        <input type="text" class="form-control" id="yf_provice" name="yf_provice" value="{{ $_getID->yf_provice }}">
                    </div>
                    <div class="col-lg-4">
                        <label>Postal Code</label>
                        <input type="text" class="form-control" id="yf_code" name="yf_code" value="{{ $_getID->yf_code }}">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-4">
                        <label>District / Area</label>
                        <input type="text" class="form-control" id="yf_dis" name="yf_dis" value="{{ $_getID->yf_dis }}">
                    </div>
                    <div class="col-lg-4">
                        <label>Sub-district / Sub-area</label>
                        <input type="text" class="form-control" id="yf_subdis" name="yf_subdis" value="{{ $_getID->yf_subdis }}">
                    </div>
                    <div class="col-lg-4">
                        <label>Road</label>
                        <input type="text" class="form-control" id="yf_road" name="yf_road" value="{{ $_getID->yf_road }}">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-8">
                        <label>Address</label>
                        <input type="text" class="form-control" id="yf_address" name="yf_address" value="{{ $_getID->yf_address }}">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-4">
                ...
                <div class="row form-group">
                    <div class="col-lg-4">
                        ...
                        <select id="yf_branch" name="yf_branch" class="form-control select2" onchange="changBranch2(this.value)" style="width:100%; height:25px;">
                            <!-- <option>Please select</option> -->
                            @foreach ($address as $val)
                                <option value="{{ $val->ct_ad_id }}" {{ ( $_getID->yf_branch == $val->ct_ad_id ? "seleted" : "") }}> {{ $val->ct_ad_branch }} </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="row form-group">
                    <div class="col-lg-4">
                        <label>Country</label>
                        <input type="text" class="form-control" id="dy_country" name="dy_country"  value="{{ $_getID->dy_country }}">
                    </div>
                    <div class="col-lg-4">
                        <label>Province</label>
                        <input type="text" class="form-control" id="dy_provice" name="dy_provice"  value="{{ $_getID->dy_provice }}">
                    </div>
                    <div class="col-lg-4">
                        <label>Postal Code</label>
                        <input type="text" class="form-control" id="dy_code" name="dy_code" value="{{ $_getID->dy_code }}">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-4">
                        <label>District / Area</label>
                        <input type="text" class="form-control" id="dy_dis" name="dy_dis" value="{{ $_getID->dy_dis }}">
                    </div>
                    <div class="col-lg-4">
                        <label>Sub-district / Sub-area</label>
                        <input type="text" class="form-control" id="dy_subdis" name="dy_subdis" value="{{ $_getID->dy_subdis }}">
                    </div>
                    <div class="col-lg-4">
                        <label>Road</label>
                        <input type="text" class="form-control" id="dy_road" name="dy_road" value="{{ $_getID->dy_road }}">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-8">
                        <label>Address</label>
                        <input type="text" class="form-control" id="dy_address" name="dy_address" value="{{ $_getID->dy_address }}">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-4">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-4">
                        <label>How to send</label>
                        <input type="text" class="form-control" id="dy_invioctext" name="dy_invioctext" value="{{ $_getID->dy_invioctext }}">
                    </div>
                </div>
