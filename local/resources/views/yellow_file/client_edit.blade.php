...
<body>
    <!-- page-wrapper -->
    <form method="post" action="{{ url('clientEditsumit') }}" enctype="multipart/form-data" >
                ...
                <div class="docs-pane">
                    ...
                    <div class="w-25">
                        <div class="text-right">
                            <button type="button" class="btn-c material-icons" title="save">save</button>
                        ...
                        <div class="card shadow-on">
                            <div class="card-body">
                              {{ csrf_field() }} 
                                <div class="row">   
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fullname" id="fullname" class="form-control" value="{{ $client->ct_fn }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Invoice name</label>
                                            <input type="text" name="invoice" id="invoice" class="form-control" value="{{ (!empty($client) ? $client->ct_inn : '' ) }}" required>
                                        </div>
                                        <div class="form-group">
                                ...
                                <?php $i = 0; ?>
                                @foreach ($address as $_val)
                                <hr class="my-5">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                <input type="hidden" id="ct_ad_id" name="ct_ad_id[]" value="{{$_val->ct_ad_id}}">
                                    <div>
                                        <h6 class="card-title font-weight-bold"><i class="material-icons float-left mr-2">room</i>Address {{$i+1}}</h6>
                                    </div>
                                    <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 mb-3">
                                        <label>Branch</label>
                                        <input type="text" class="form-control" id="Branch" name="Branch[]" value="{{$_val->ct_ad_branch}}">
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                        <label>Phone</label>
                                        <input type="text" class="form-control" id="phone" name="phone[]" value="{{$_val->ct_ad_phone}}">
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                        <label>Fax</label>
                                        <input type="text" class="form-control" id="Fax" name="Fax[]" value="{{$_val->ct_ad_fax}}">
                                    </div>
                                </div>
                                <div class="row">
                                <div class="col-lg-4 mb-3">
                                        <label>Email address</label>
                                        <input type="text" class="form-control" id="email" name="email[]" value="{{$_val->ct_ad_mail}}">
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                        <label>Attention</label>
                                        <input type="text" class="form-control" id="attent" name="attent[]" value="{{$_val->ct_ad_atten}}">
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                        <label>Option</label>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="yf_confict_{{$i}}" name="invoicepotion{{$i}}" value="1" {{ ( $_val->ct_ad_invoice == "1" ? "checked" : "") }}>
                                            <label class="form-check-label" for="yf_confict_{{$i}}">
                                                YES
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="yf_confict_{{$i+1}}" name="invoicepotion{{$i}}" value="2" {{ ( $_val->ct_ad_invoice == "2" ? "checked" : "") }}>
                                            <label class="form-check-label" for="yf_confict_{{$i+1}}">
                                            No
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <label>Address</label>
                                        <textarea class="form-control" id="Address" name="Address[]" >{{$_val->ct_ad}}</textarea>
                                    </div>
                                </div>
                                <?php $i++; ?>
                            @endforeach   
                            <div class="clonefile" id="div_{{$i}}"></div>
        ...
        $(document).ready(function(){
            ...
            if(total_element < max ){
                ...
                var table = '<hr class="my-5"><div class="d-flex align-items-center justify-content-between mb-4">';
                    table += '<input type="hidden" id="ct_ad_id" name="ct_ad_id[]" />';
